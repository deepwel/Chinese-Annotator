...
insert_neg_str="{text: \"我是个垃圾##！\", labeled: true, dataset_uuid: \"5a6840b28831a3e06abbbcc9\"}"
insert_pos_str="{text: \"我是荣耀王者##！\", labeled: true, dataset_uuid: \"5a6840b28831a3e06abbbcc9\"}"
max_sample=10
